...
<head>
    ...
    <link rel="apple-touch-icon-precomposed"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-precomposed"/>
    <link rel="apple-touch-icon-precomposed" sizes="180x180"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-180x180.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="57x57"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-57x57.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-114x114.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-72x72.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-144x144.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="60x60"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-60x60.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="120x120"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-120x120.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="76x76"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-76x76.png"/>
    <link rel="apple-touch-icon-precomposed" sizes="152x152"
          href="<?= $this->theme->getBaseUrl(); ?>/ico/apple-touch-icon-152x152.png"/>
