...
<div class="outside text-center login-container-home">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <div class="topbar-brand">
                <?= humhub\widgets\SiteLogo::widget(['place' => 'topMenu']); ?>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="signin-form col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
                ...
                <img class="img-responsive visible-xs banner-small" src="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/img/home-banner-small.png">
                ...
                <?php echo $form->field($model, 'username')->textInput(['id' => 'login_username', 'placeholder' => Yii::t('UserModule.views_auth_login', 'username or email')])->label(false); ?>
                <?php echo $form->field($model, 'password')->passwordInput(['id' => 'login_password', 'placeholder' => Yii::t('UserModule.views_auth_login', 'password')])->label(false); ?>
                ...
                <a onclick="$('#quotes').animatescroll({padding:50,scrollSpeed:1000,easing:'easeInOutCirc'});">
                    <img class="down-arrow" src="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/img/caret.png"></a>
            </div>
        </div>
...
<div class="container text-center">
    <div class="row quote-section">
        <div class="col-xs-12" id="quotes">
            <img src="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/img/tc-apple.png">
            <?php echo $this->render('@app/../themes/tq/views/quotes/quotes', array()); ?>
        </div>
    </div>
</div>
...
<div class="container community-details">
    ...
    <div class="row row-padding-md">
        ...
        <div class="col-sm-3 col-sm-offset-2 col-xs-12">
            <img class="img-responsive" src="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/img/tc-community-1.png">
        </div>
    </div>
    ...
    <div class="row row-padding-md">
        ...
        <div class="col-sm-3 col-sm-offset-2 col-sm-pull-6 col-xs-12">
            <img class="img-responsive" src="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/img/tc-community-2.png">
        </div>
    </div>
    ...
    <div class="row row-padding-md">
        ...
        <div class="col-sm-3 col-sm-offset-2 col-xs-12">
            <img class="img-responsive" src="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/img/tc-community-3.png">
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 contact-details">
                    <div class="row">
                        <div class="col-xs-12"><?= humhub\widgets\SiteLogo::widget(['place' => 'topMenu']); ?></div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                ...
                <div class="col-lg-3 col-lg-offset-2 col-md-4 col-md-offset-1 text-center" id="contact">
                    ...
                    <!--<form id="email_form" method="post" action="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/mail.php">
                        <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <img class="img-responsive" src="<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/img/tc-register.png">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-8 col-sm-offset-2">
                        ...
                        <?php echo $form->field($registerModel, 'email')->textInput(['id' => 'register-email', 'placeholder' => Yii::t('UserModule.views_auth_login', 'email')])->label(false); ?>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        //IECheck();
        <?php if($registerModel->getErrors('email')) { ?>
    ...
    $(document).ready(function(){
        ...
        mailgunURL = '<?php echo Yii::$app->getView()->theme->getBaseUrl(); ?>/mail.php';
