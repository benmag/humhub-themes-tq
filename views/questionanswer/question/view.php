                        ...
                        <div class="media-body" style="padding-top:5px; ">
                                	...
                                	<div class="row">
                                        ...
                                        <div class="col-sm-12">
											...
											if(Yii::$app->user->isAdmin() || $model->created_by == Yii::$app->user->id) {
												echo Html::a("<div class='qanda-button pull-left' style='margin-left:0px;'><span class='icon icon-pencil'></span> Edit</div>", array('update', 'id'=>$model->id));
											} ?>
											<?php if(Yii::$app->user->isAdmin()) {
                                                echo Html::a('<div class="qanda-button pull-left"><span class="icon icon-trash"></span> Delete</div>', ['delete', 'id'=>$model->id], array(
                                                'submit'=>url::to('delete',array('id'=>$model->id)),
                            ...
                            if($comments) {
                                foreach($comments as $comment) {
                                    ...
                                    echo "<a class='display-name' href=\"". url::to('//user/profile', array('uguid' => $comment->user->guid)) . "\">" . $comment->user->displayName . "</a>";
									...
									if(Yii::$app->user->isAdmin()) {
                                        ...
                                        echo Html::a('<div class="qanda-button pull-right"><span class="icon icon-trash"></span> Delete</div>', ['//questionanswer/comment/delete', 'id'=>$comment->id], array(
