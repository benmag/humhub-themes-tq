        ...
        <div class="pull-right">
            <?php if (count($message->users) != 0) : ?>
                ...
                <?php foreach ($message->users as $user) : ?>
                    <a class="profile-size-sm pull-left" href="<?php echo $user->getUrl(); ?>">
                        <img src="<?php echo $user->getProfileImage()->getUrl(); ?>"
                             class="img-rounded tt img_margin profile-size-sm" height="29" width="29"
                        ...
                        <div class="profile-overlay-img profile-overlay-img-sm tt" data-toggle="tooltip" data-placement="top" title="" data-original-title="<strong> <?php echo Html::encode($user->displayName); ?></strong><br><?php echo Html::encode($user->profile->title); ?>"></div>
                    </a>
                <?php endforeach; ?>
            <?php endif; ?>
        </div>
