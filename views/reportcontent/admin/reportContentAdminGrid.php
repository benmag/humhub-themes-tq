    ...
    <table class="table table-hover">
        ...
        <tbody>
            <?php foreach ($reportedContent as $report) : ?>
                <?php $object = $report->getSource();  ?>
                <tr>
                    <td width="52px">
                        <?php
                        if(get_class($object) != "humhub\modules\questionanswer\models\Question") { ?>
                    ...
                    <td>
                        <div class="content" style="max-height: 40px; max-width:250px;">
                            ...
                            <?php
                            if(get_class($object) == "humhub\modules\questionanswer\models\Question") {
                                echo Html::a("View", $object::getUrl(array('id'=>$object->id)), array('class' => 'btn btn-primary'));
                            } else { ?>
