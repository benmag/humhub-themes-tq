...
<?php if ($workspace != null && !Yii::app()->controller instanceof ContentContainerController): ?>
    <?php echo Yii::t('ActivityModule.views_activities_ActivitySpaceCreated', "<i class='fa fa-dot-circle-o color-circle-mentorship' style='margin-right: 5px;vertical-align: middle;'></i> %displayName% created the new space %spaceName%", array(
