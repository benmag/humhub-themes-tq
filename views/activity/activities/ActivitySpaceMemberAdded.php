...
<!---->
<!--    --><?php //echo Yii::t('ActivityModule.views_activities_ActivitySpaceMemberAdded', "<i class='fa fa-dot-circle-o color-circle-mentorship' style='margin-right: 5px;vertical-align: middle;'></i> %displayName% joined the space %spaceName%", array(
