...
<?php if ($workspace != null && !Yii::app()->controller instanceof ContentContainerController): ?>
    ...
    <?php echo Yii::t('ActivityModule.views_activities_ActivitySpaceMemberAdded', "<i class=\"fa fa-dot-circle-o color-circle-mentorship\" style='margin-right: 5px;color: #158694;vertical-align: middle;'></i> %displayName% joined the space %spaceName%", array(
