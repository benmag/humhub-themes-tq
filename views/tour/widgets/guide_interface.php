    ...
    interfaceTour.addSteps([
        {
            ...
            orphan: true,
            backdrop: true,
            title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_interface', '<strong>Home</strong>')); ?>,
            content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_interface', "This is your home.<br><br>Any new activities or posts that might interest you will be displayed here.")); ?>
        },
        {
