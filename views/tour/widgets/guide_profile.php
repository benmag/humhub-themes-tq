    ...
    profileTour.addSteps([
        {
            ...
            content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', "This is your user profile, which can be seen by any registered user.")); ?>
        },
        {
        ...
        },
        {
            ...
            content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', 'Each profile has its own pin board. Your posts will also appear on the home screens of those users who are following you.')); ?>,
            placement: "bottom"
        },
