...
<div class="media">
    ...
    <a href="<?php echo $object->content->user->getProfileUrl(); ?>" class="pull-left profile-size-md">
        <img class="media-object profile-size-md img-rounded user-image user-<?php echo $object->content->user->guid; ?>" alt="40x40" data-src="holder.js/40x40"
