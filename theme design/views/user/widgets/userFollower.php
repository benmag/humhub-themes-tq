    ...
    <div class="panel panel-default follower" id="profile-follower-panel">
        ...
        <div class="panel-body">
            <?php foreach ($followers as $follower): ?>
                <a class="profile-size-xs pull-left" href="<?php echo $follower->getProfileUrl(); ?>">
                    <img src="<?php echo $follower->getProfileImage()->getUrl(); ?>" class="img-rounded profile-size-xs tt img_margin"
                         ...
                         data-original-title="<strong><?php echo CHtml::encode($follower->displayName); ?></strong><br><?php echo CHtml::encode($follower->profile->title); ?>"></div>
                </a>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="panel panel-default follower" id="profile-following-panel">
        ...
        <div class="panel-body">
            <?php foreach ($following as $followingUser): ?>
                <a class="profile-size-xs pull-left" href="<?php echo $followingUser->getProfileUrl(); ?>">
                    <img src="<?php echo $followingUser->getProfileImage()->getUrl(); ?>" class="img-rounded tt img_margin profile-size-xs"
                         height="24" width="24" alt="24x24" data-src="holder.js/24x24"
                         style="width: 24px; height: 24px;"
                         data-toggle="tooltip" data-placement="top" title=""
                         ...
                         <div class="profile-overlay-img profile-overlay-img-xs tt" data-toggle="tooltip" data-placement="top" title=""
                         data-original-title="<strong><?php echo CHtml::encode($followingUser->displayName); ?></strong><br><?php echo CHtml::encode($followingUser->profile->title); ?>"></div>
                </a>
            <?php endforeach; ?>
        </div>
    </div>
